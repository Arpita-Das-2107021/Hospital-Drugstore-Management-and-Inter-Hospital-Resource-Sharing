...
from common.permissions.base import CanViewAuditLogs
from common.utils.pagination import StandardResultsPagination
from common.utils.response import success_response

from .models import AuditLog, AuthorizationAuditLog
from .serializers import AuditLogSerializer, AuthorizationAuditLogSerializer
...
class AuthorizationAuditLogViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        qs = AuthorizationAuditLog.objects.select_related("user", "hospital").order_by("-timestamp")
