// frontend/src/pages/hospital-admin/StaffInvitations.tsx
...
const StaffInvitations: React.FC = () => {
  const { user } = useAuth();
  const canManageInvitations = hasAnyPermission(user, ['hospital:invitation.view', 'hospital:invitation.manage', 'hospital:user_role.assign', 'hospital:staff.manage']);
  const canManageAcrossHospitals = false;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.hospital) (invitationData as unknown).hospital = formData.hospital;
  ...
  return (
    <AppLayout title="Staff Invitations"
      // subtitle="Invite and manage staff members for your hospital"
    >
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setFormData((prev) => ({
                    ...
                    hospital: selected?.hospital || prev.hospital,
                  }));
                }}
