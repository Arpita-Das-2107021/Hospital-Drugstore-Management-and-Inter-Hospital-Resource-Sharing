...
type FailedApiKey = 'healthcheck' | 'resources' | 'bed' | 'blood' | 'staff' | 'sales';
...
const normalizeFailedApiKey = (rawKey: string): FailedApiKey | null => {
  ...
  if (normalized === 'healthcheck' || normalized === 'health') return 'healthcheck';
      ...
      <div className="space-y-6 max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button variant="outline" onClick={focusReviewSection}>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          {/* Optional API health checks for submitted integration */}
          {shouldShowApiVerificationConsole ? (
          ...
          <Card className="md:col-span-2" ref={reviewSectionRef}>
            <CardHeader>
              <CardTitle className="text-base">Review / Send Feedback to Hospital</CardTitle>
              <CardDescription>
                Send a formal review email to the registration contact without changing approval or rejection workflow.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-3 md:grid-cols-2">
                <div className="space-y-1">
                  <Label htmlFor="review-recipient">Recipient Email</Label>
                  <Input
                    id="review-recipient"
              ...
              <div className="space-y-1">
                ...
                <Textarea
                  ...
                  rows={7}
                  placeholder="Describe what should be corrected before approval."
                />
              </div>
              ...
              <div className="flex justify-end">
                <Button
                  ...
                  disabled={sendReviewLoading || !reviewRecipientEmail}
                >
                  {sendReviewLoading ? (
                    <>
                      ...
                      return (
                        <div key={entry.id || `${entry.actor_email}-${entry.created_at}`} className="rounded-md border bg-background px-3 py-2 text-xs space-y-1">
                          ...
                          <p>
                            ...
                            {historyFailedApis.length > 0 ? historyFailedApis.join(', ') : 'None'}
                          </p>
                          {entry.message ? (
